...
class CloudPreferences:
    ...
    def alexa_report_state(self):
        ...
        return self._prefs[PREF_ALEXA_REPORT_STATE] or DEFAULT_ALEXA_REPORT_STATE
    ...
    def google_report_state(self):
        ...
        return self._prefs[PREF_GOOGLE_REPORT_STATE] or DEFAULT_GOOGLE_REPORT_STATE
